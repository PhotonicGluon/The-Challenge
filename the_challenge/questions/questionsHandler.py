...
class QuestionsHandler:
    def __init__(self, seed_value=None):
        """
        Initialise the questions' handler.
    ...
    def setup_questions(self):
        ...
        Returns:
            ...
            List[Union[str, int, float, List[Union[int, float]]]]:  The answers to the questions.
        """
...
if __name__ == "__main__":
    questionsHandler = QuestionsHandler(seed_value="Theorem")
    questions, prefixes, answers = questionsHandler.setup_questions()
